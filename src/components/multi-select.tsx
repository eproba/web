      ...
      <>
        ...
        >
          <div id={triggerDescriptionId} className="sr-only">
            Wielokrotny wybór. Użyj strzałek do nawigacji, Enter aby wybrać,
            Escape aby zamknąć.
          </div>
          <div id={selectedCountId} className="sr-only" aria-live="polite">
            {selectedValues.length === 0
              ? "Nie wybrano żadnych opcji"
              : `${selectedValues.length} opcja${selectedValues.length === 1 ? "" : "(e)"} wybrana: ${selectedValues
                        ...
                        return (
                          ...
                          >
                            ...
                            <div
                              ...
                              className="-m-0.5 ml-2 inline-flex h-4 w-4 cursor-pointer items-center justify-center rounded-sm p-0.5 hover:bg-white/20 focus:ring-1 focus:ring-white/50 focus:outline-none"
                            >
                              <XCircle
                                className={cn(
                                  "h-3 w-3",
            ...
            <Command>
              {searchable && (
                <CommandInput
                  ...
                  aria-label="Szukaj dostępnych opcji"
                  aria-describedby={`${multiSelectId}-search-help`}
                />
              )}
              {searchable && (
                <div id={`${multiSelectId}-search-help`} className="sr-only">
                  Wpisz, aby filtrować opcje. Użyj strzałek do nawigacji.
                </div>
              )}
              <CommandList
                className={cn(
                ...
                {!hideSelectAll && !searchValue && (
                  <CommandGroup>
                    <CommandItem
                      ...
                      aria-label={`Zaznacz wszystkie (${getAllOptions().length} opcji)`}
